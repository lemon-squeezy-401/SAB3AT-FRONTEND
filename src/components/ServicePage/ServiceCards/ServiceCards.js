            ...
            <div>
              <div class="product2">
                ...
                <div class="product-text">
                  <p>
                    {' '}
                    Have your document translated into more than 100 languages
          ...
          <div class="service1 card1">
            <div>
              <div class="product2">
                ...
                <div class="product-text">
                  <p>
                    Design apartments - villa - pistons - kitchens Using
                    software (ps-lumion-AutoCAD-3ds max).
                  </p>
                  <button class="btn">
          ...
          <div class="service1 card1">
            <div>
              <div class="product2">
                ...
                <div class="product-text">
                  <p>
                    Professional and high quality motion graphic design
                    (Snapchat _ Story Instagram).
                    <br />
                    <br />
                  </p>
                  <button class="btn">
            ...
            <div>
              <div class="product2">
                ...
                <div class="product-text">
                  <p>
                    {' '}
                    A comprehensive marketing study help you build your project
                    or increase its position in the market on scientific
                    grounds.
                  </p>
                  <button class="btn">
