    ...
    return (
      <html lang="en" className="myStyle">
        <head>
          ...
          <link
            href={
              'https://fonts.googleapis.com/css?family=Bentham|Playfair+Display|Raleway:400,500|Suranna|Trocchi'
            }
            rel="stylesheet"
          />
        </head>
        <body>
          <div className="wrapper">
            <div className="product-img">
              <img
                src={
                  'http://royaumeacademy.co.uk/wp-content/uploads/2015/06/translation-globe350.png'
                }
                height="420"
                width="327"
                alt="servicePic"
